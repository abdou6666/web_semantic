...
import DisplayAllReclamationsAndResponsesWithClientAndAdminData
    from './components/DisplayAllReclamationsAndResponsesWithClientAndAdminData';
import ShowSearchResult from './components/ShowSearchResult';
import DisplayAllOrdersAndPayements from "./components/DisplayAllOrdersAndPayements.jsx";
...
function App() {
    ...
    return (
        <div>
            ...
            <div>
                <button onClick={() => setDisplayReclamationAndResponses(prev => !prev)}>Display All Reclamations with
                    responses
                </button>
                {allReclamationsAndResponses && displayReclamationAndResponses &&
                    <DisplayAbdouReclamationWithResponses allReclamationsAndResponses={allReclamationsAndResponses}/>}
            </div>
            ...
            <div>
                ...
                {allReclamationsAndResponsesWithClientAndAdminData && displayAllReclamationsAndResponsesWithClientAndAdminData &&
                    <DisplayAllReclamationsAndResponsesWithClientAndAdminData
                        allReclamationsAndResponsesWithClientAndAdminData={allReclamationsAndResponsesWithClientAndAdminData}/>}
            </div>

            <div>
                <input type="text" placeholder='search for reclamation' value={searchReclamationInput}
